	...
	<div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo form_open('product/subcategory/edit/' . $subCategory->id) ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            ...
                            <select id="assetCat" class="form-control" name="assetCat">
                                ...
                                <?php foreach($categoryList as $categoryData): ?>
                                    <option value="<?php echo $categoryData->cat_id; ?>" <?php echo $categoryData->cat_id == $subCategory->cat_id ? "selected" : ''; ?>><?php echo $categoryData->catName; ?></option>
                                <?php endforeach; ?>
                            </select>
                        </div>
                        <div class="form-group">
                            <label>ชื่อหมวดหมู่ทรัพย์สิน</label>
                            <input id="txt_subcategory" class="form-control" name="txt_subcategory" value="<?php echo $subCategory->subTypeName ?>" placeholder="ชื่อหมวดหมู่ทรัพย์สิน">
                        </div>
                    </div>
                </div>
