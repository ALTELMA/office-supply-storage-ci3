<div id="content">    
    ...
    <div class="formData">
    	<form method="POST" action="<?php base_url().'asset/categoryAdd'?>">
            ...
            <input type="text" id="txt_type" name="txt_type" value="<?php echo $categoryData->catType;?>">
        	<label>ชื่อประเภททรัพย์สิน : </label>
            <input type="text" id="txt_category" name="txt_category" value="<?php echo $categoryData->catName;?>">
            <div class="submit">
