    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <?php echo form_open_multipart('product/attach/edit/' . $attachData->id) ?>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="form-group">
                            <label>ชื่อไฟล์แนบ</label>
                            <input id="txt_filename" class="form-control" name="txt_filename" placeholder="รหัสทรัพย์สิน" value="<?php echo $attachData->fileName; ?>">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="txt_remark" class="form-control" name="txt_remark"><?php echo $attachData->remark; ?></textarea>
                        </div>
                    </div>
                </div>
