...
require_once 'OLE_Root.php';
require_once 'OLE_File.php';
...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
    ...
    */
    ...
    {
        $OLE = new PHPExcel_Writer_Excel5_OLE_PPS_File(PHPExcel_Writer_Excel5_OLE::Asc2Ucs('Book'));
        if ($this->_tmp_dir != '') {
        ...
        $root = new PHPExcel_Writer_Excel5_OLE_PPS_Root(time(), time(), array($OLE));
        if ($this->_tmp_dir != '') {
