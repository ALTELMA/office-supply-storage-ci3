...
class PHPExcel_RichText
{
    ...
    public function __construct($pCell = null)
    {
    	...
    	if ($pCell instanceof PHPExcel_Cell) {
    		...
    		throw new Exception("Invalid parent PHPExcel_Cell passed.");
    	}
    }
    ...
    {
    	if ($pText instanceof PHPExcel_RichText_ITextElement) {
    		$this->_richTextElements[] = $pText;
    	} else {
    		throw new Exception("Invalid PHPExcel_RichText_ITextElement instance passed.");
    	}
    }
