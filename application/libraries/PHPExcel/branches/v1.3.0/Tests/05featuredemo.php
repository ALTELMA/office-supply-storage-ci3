...
$objPHPExcel->getActiveSheet()->setCellValue('A18', 'This invoice is payable within thirty days after the end of the month, unless specified otherwise on the invoice.');
