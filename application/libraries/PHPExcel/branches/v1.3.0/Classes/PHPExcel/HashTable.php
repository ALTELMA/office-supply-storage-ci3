...
class PHPExcel_HashTable
{
    ...
    public function add($pSource = null) {
    	if ($pSource instanceof PHPExcel_IComparable) {
    		...
    		throw new Exception('Elements must implement PHPExcel_IComparable');
    	}
    }
    ...
    public function remove($pSource = null) {
    	if ($pSource instanceof PHPExcel_IComparable) {
    		...
    		throw new Zend_Pdf_Exception('Elements must implement PHPExcel_IComparable');
    	}
    }
