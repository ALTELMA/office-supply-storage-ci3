...
class PHPExcel_Calculation
{
	...
	protected function __construct() {
		...
		if (is_null($this->_functionMappings)) {
			$this->_functionMappings = array(
				...
				'AVERAGE' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'AVERAGE', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'AVERAGEA' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'AVERAGEA', 			'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'CONCATENATE' 			=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_TEXT_AND_DATA, 		'CONCATENATE', 			'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'COUNTA' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'COUNTA', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'DEVSQ' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'DEVSQ', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'EFFECT' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'EFFECT', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'FV' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'FV', 					'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'MAXA' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'MAXA', 				'PHPExcel_Calculation_Functions::MAX'),
				...
				'MEDIAN' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'MEDIAN', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'MINA' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'MINA', 				'PHPExcel_Calculation_Functions::MIN'),
				...
				'MODE' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'MODE', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'NOMINAL' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'NOMINAL', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'NPER' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'NPER', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'NPV' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'NPV', 					'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'PMT' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'PMT', 					'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'POWER' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_MATH_AND_TRIG,		 	'POWER', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'PV' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_FINANCIAL, 			'PV', 					'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'STDEV' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'STDEV', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'STDEVA' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'STDEVA', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'STDEVP' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'STDEVP', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'STDEVPA' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'STDEVPA', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'TRUNC' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_MATH_AND_TRIG,			'TRUNC', 				'PHPExcel_Calculation_Functions::DUMMY'),
				...
				'VAR' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'VAR', 					'PHPExcel_Calculation_Functions::DUMMY'),
				'VARA' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'VARA', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'VARP' 					=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'VARP', 				'PHPExcel_Calculation_Functions::DUMMY'),
				'VARPA' 				=> new PHPExcel_Calculation_Function(PHPExcel_Calculation_Function::CATEGORY_STATISTICAL, 			'VARPA', 				'PHPExcel_Calculation_Functions::DUMMY'),
	...
	public function calculate($pCell = null) {
		if ($pCell instanceof PHPExcel_Cell) {
			...
			for ($i = 0; $i < $objParser->getTokenCount(); $i++) {
				...
				if ( ($token->getTokenType() == PHPExcel_Calculation_FormulaToken::TOKEN_TYPE_OPERAND) &&
					 ...
					 (!$inFunction) ) {
					 	...
					 	array_push(
					 		...
					 		$pCell->getParent()->getCell( $token->getValue() )->getCalculatedValue()
					 	);
				...
				if ( ($token->getTokenType() == PHPExcel_Calculation_FormulaToken::TOKEN_TYPE_OPERAND) &&
					 ...
					 ($inFunction) ) {
					 	...
					 	array_push(
					 		$executableFormulaArray,
					 		'$this->_extractRange("' . $token->getValue() . '", $pCell->getParent())'
					 	);
			...
			// Evaluate formula
			try {
				$errorLevelBefore = error_reporting(0);
		    	$returnValue = eval('return ' . implode('', $executableFormulaArray) . ';');
		    	error_reporting($errorLevelBefore);
			} catch (Exception $ex) {
				$returnValue = '#N/A';
			}
			...
			throw new Exception("Invalid PHPExcel_Cell object passed.");
		}
	}
	 ...
	 * @throws 	Exception
	 */
	private function _extractRange($pRange = 'A1', $pSheet = null) {
		if ($pSheet instanceof PHPExcel_Worksheet) {
			// Return value
			$returnValue = array();
			
			// Extract range start and range end
			$rangeStart	= '';
			$rangeEnd	= '';
			if (strpos($pRange, ':') === false) {
				...
				list($rangeStart, $rangeEnd) = explode(':', $pRange);
			}
			...
			while ($currentCol >= $startingCol && $currentCol <= $endingCol) {	
				$returnValue[$currentCol] = array();
				
				while ($currentRow >= $startingRow && $currentRow <= $endingRow) {
					$returnValue[$currentCol][$currentRow] = $pSheet->getCellByColumnAndRow($currentCol, $currentRow)->getCalculatedValue();
