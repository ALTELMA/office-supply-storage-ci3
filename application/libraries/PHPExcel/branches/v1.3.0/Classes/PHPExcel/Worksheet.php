...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
     ...
     * @throws 	Exception
     */
    public function setAutoFilterByColumnAndRow($pColumn = 0, $pRow = 0)
    {
    	$this->setAutoFilter(PHPExcel_Cell::stringFromColumnIndex($pColumn) . $pRow);
    }
     ...
     * @throws 	Exception
     */
    function insertNewRowBefore($pBefore = 1, $pNumRows = 1) {
    	if ($pBefore >= 1) {
     ...
     * @throws 	Exception
     */
    function insertNewColumnBefore($pBefore = 'A', $pNumCols = 1) {
     ...
     * @throws 	Exception
     */
    function insertNewColumnBeforeByIndex($pBefore = 0, $pNumCols = 1) {
    	if ($pBefore >= 1) {
     ...
     * @throws 	Exception
     */
    function removeRow($pRow = 1, $pNumRows = 1) {
    	if ($pRow >= 1) {
    		$objReferenceHelper = PHPExcel_ReferenceHelper::getInstance();
     ...
     * @throws 	Exception
     */
    function removeColumn($pColumn = 'A', $pNumCols = 1) {
     ...
     * @throws 	Exception
     */
    function removeColumnByIndex($pColumn = 0, $pNumCols = 1) {
    	if ($pBefore >= 1) {
