			...
			$objWriter->startElement('cols');
				...
				foreach ($pSheet->getColumnDimensions() as $colDimension) {
					...
					if (!$colDimension->getAutoSize()) {
						...
						// Auto size set, calculate maximal column width
						$maxWidth 	= 0;
						$tempWidth 	= 0;
						...
						foreach ($cellCollection as $cell) {
							if ($cell->getColumn() == $colDimension->getColumnIndex()) {
								$tempWidth = PHPExcel_Shared_Font::calculateColumnWidth(
									$pSheet->getStyle( strtoupper($cell->getCoordinate()) )->getFont()->getSize(),
									false,
						...
						$objWriter->writeAttribute('width', 	$maxWidth);
