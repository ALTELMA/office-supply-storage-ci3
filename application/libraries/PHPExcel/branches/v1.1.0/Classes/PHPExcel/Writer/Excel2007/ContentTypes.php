...
class PHPExcel_Writer_Excel2007_ContentTypes extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	public function writeContentTypes($pPHPExcel = null)
	{
	...
	private function _getImageMimeType($pFile = '')
	{
		if (file_exists($pFile)) {
			...
			return image_type_to_mime_type($image[2]);
	 		throw new Exception("No mime type found for image $pFile");
		} else {
	...
	{
		if ($objWriter instanceof xmlWriter && $pPartname != '' && $pContentType != '') {
			// Write content type
