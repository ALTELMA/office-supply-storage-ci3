				...
				$objWriter->startElement('a:themeElements');
					...
					$objWriter->writeAttribute('name', 'Office');
						...
						$objWriter->startElement('a:majorFont');
							...
							$objWriter->writeAttribute('script', 'Grek');
							$objWriter->writeAttribute('typeface', '');
							$objWriter->endElement();
						
							// a:font
							$objWriter->startElement('a:font');
							$objWriter->writeAttribute('script', 'Cyrl');
							$objWriter->writeAttribute('typeface', '');
							$objWriter->endElement();
					...
					$objWriter->writeAttribute('name', 'Office');
								...
								$objWriter->startElement('a:gsLst');
									...
									$objWriter->writeAttribute('pos', '0');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											$objWriter->writeAttribute('val', '98000');
											$objWriter->endElement();
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('pos', '25000');
									...
									$objWriter->writeAttribute('pos', '100000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:tint
											$objWriter->startElement('a:tint');
											$objWriter->writeAttribute('val', '5000');
											$objWriter->endElement();
								...
								$objWriter->startElement('a:gsLst');
									...
									$objWriter->writeAttribute('pos', '0');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '160000');
											$objWriter->endElement();
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('pos', '62000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '125000');
											$objWriter->endElement();
									...
									$objWriter->writeAttribute('pos', '100000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '140000');
											$objWriter->endElement();
						...
						$objWriter->startElement('a:lnStyleLst');
							...
							$objWriter->writeAttribute('w', '6350');
							...
							// a:ln
							$objWriter->startElement('a:ln');
							$objWriter->writeAttribute('w', '34925');
							$objWriter->writeAttribute('cap', 'rnd');
							$objWriter->writeAttribute('cmpd', 'sng');
							$objWriter->writeAttribute('algn', 'ctr');
						...
						$objWriter->startElement('a:effectStyleLst');
							...
							$objWriter->startElement('a:effectStyle');
								...
								$objWriter->startElement('a:effectLst');
									...
									$objWriter->writeAttribute('blurRad', '63500');	
									$objWriter->writeAttribute('dist', '25400');	
									$objWriter->writeAttribute('dir', '5400000');	
										...
										$objWriter->writeAttribute('val', '000000');
											...
											$objWriter->writeAttribute('val', '43137');					
											$objWriter->endElement();	
							...
							$objWriter->startElement('a:effectStyle');
								...
								$objWriter->startElement('a:effectLst');
									...
									// a:outerShdw
									$objWriter->startElement('a:outerShdw');
									$objWriter->writeAttribute('blurRad', '50800');	
									$objWriter->writeAttribute('dist', '38100');	
									$objWriter->writeAttribute('dir', '5400000');	
										...
										$objWriter->writeAttribute('val', '000000');
											...
											// a:alpha
											$objWriter->startElement('a:alpha');
											$objWriter->writeAttribute('val', '45882');					
											$objWriter->endElement();	
								...
								$objWriter->startElement('a:scene3d');
									...
									$objWriter->writeAttribute('fov', '0');	
									...
									$objWriter->writeAttribute('rig', 'contrasting');	
									$objWriter->writeAttribute('dir', 't');	
										...
										$objWriter->writeAttribute('lat', '0');
										$objWriter->writeAttribute('lon', '0');
										$objWriter->writeAttribute('rev', '16500000');
										$objWriter->endElement();	
								...
								$objWriter->writeAttribute('contourW', '12700');	
								$objWriter->writeAttribute('prstMaterial', 'powder');	

									// a:bevelT
									$objWriter->startElement('a:bevelT');
									$objWriter->writeAttribute('h', '50800');	
									$objWriter->endElement();
							...
							$objWriter->startElement('a:effectStyle');
								...
								$objWriter->startElement('a:effectLst');
									...
									// a:reflection
									$objWriter->startElement('a:reflection');
									$objWriter->writeAttribute('blurRad', '12700');	
									$objWriter->writeAttribute('stA', '25000');	
									$objWriter->writeAttribute('endPos', '28000');
									$objWriter->writeAttribute('dist', '38100');	
									$objWriter->writeAttribute('dir', '5400000');	
									$objWriter->writeAttribute('sy', '-100000');	
									$objWriter->endElement();
								...
								$objWriter->writeAttribute('prstMaterial', 'powder');	
									...
									// a:bevelT
									$objWriter->startElement('a:bevelT');
									$objWriter->writeAttribute('w', '139700');	
									$objWriter->writeAttribute('h', '38100');	
									$objWriter->endElement();
								...
								$objWriter->startElement('a:gsLst');
									...
									$objWriter->writeAttribute('pos', '0');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '250000');
											$objWriter->endElement();
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('pos', '20000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '175000');
											$objWriter->endElement();
									...
									$objWriter->writeAttribute('pos', '100000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:tint
											$objWriter->startElement('a:tint');
											$objWriter->writeAttribute('val', '70000');
											$objWriter->endElement();
								...
								$objWriter->startElement('a:gsLst');
									...
									$objWriter->writeAttribute('pos', '0');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '145000');
											$objWriter->endElement();
									...
									// a:gs
									$objWriter->startElement('a:gs');
									$objWriter->writeAttribute('pos', '30000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '155000');
											$objWriter->endElement();
									...
									$objWriter->writeAttribute('pos', '100000');
										...
										$objWriter->writeAttribute('val', 'phClr');
											...
											// a:tint
											$objWriter->startElement('a:tint');
											$objWriter->writeAttribute('val', '60000');
											$objWriter->endElement();
											
											// a:satMod
											$objWriter->startElement('a:satMod');
											$objWriter->writeAttribute('val', '170000');
											$objWriter->endElement();
