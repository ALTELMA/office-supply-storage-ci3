...
class PHPExcel_Writer_Excel2007_Worksheet extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheetPr(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// sheetPr
	 ...
	 * @throws 	Exception
	 */
	private function _writeDimension(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// dimension
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheetViews(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// sheetViews
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheetFormatPr(xmlWriter $objWriter = null)
	{
		// sheetFormatPr
	 ...
	 * @throws 	Exception
	 */
	private function _writeCols(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// cols
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheetProtection(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// sheetProtection
	 ...
	 * @throws 	Exception
	 */
	private function _writeConditionalFormatting(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// Conditional id
		$id = 1;
	 ...
	 * @throws 	Exception
	 */
	private function _writeDataValidations(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{	
	 ...
	 * @throws 	Exception
	 */
	private function _writeProtectedRanges(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeMergeCells(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writePrintOptions(xmlWriter $objWriter = null)
	{
		// printOptions
	 ...
	 * @throws 	Exception
	 */
	private function _writePageMargins(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// pageMargins
	 ...
	 * @throws 	Exception
	 */
	private function _writeAutoFilter(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{	
	 ...
	 * @throws 	Exception
	 */
	private function _writePageSetup(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{	
		// pageSetup
	 ...
	 * @throws 	Exception
	 */
	private function _writeHeaderFooter(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
		// headerFooter
	 ...
	 * @throws 	Exception
	 */
	private function _writeBreaks(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheetData(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, $pStringTable = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeCell(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null, PHPExcel_Cell $pCell = null, $pStringTable = null, $pFlippedStringTable = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeDrawings(xmlWriter $objWriter = null, PHPExcel_Worksheet $pSheet = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeRichText(xmlWriter $objWriter = null, PHPExcel_RichText $pRichText = null)
	{
