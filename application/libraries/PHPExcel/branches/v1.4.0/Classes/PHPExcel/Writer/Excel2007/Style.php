...
class PHPExcel_Writer_Excel2007_Style extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	private function _writeFill(xmlWriter $objWriter = null, PHPExcel_Style_Fill $pFill = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeGradientFill(xmlWriter $objWriter = null, PHPExcel_Style_Fill $pFill = null)
	{
		// fill
	 ...
	 * @throws 	Exception
	 */
	private function _writePatternFill(xmlWriter $objWriter = null, PHPExcel_Style_Fill $pFill = null)
	{
		// fill
		$objWriter->startElement('fill');
	 ...
	 * @throws 	Exception
	 */
	private function _writeFont(xmlWriter $objWriter = null, PHPExcel_Style_Font $pFont = null)
	{
		// font
	 ...
	 * @throws 	Exception
	 */
	private function _writeBorder(xmlWriter $objWriter = null, PHPExcel_Style_Borders $pBorders = null)
	{
		// Write border
	 ...
	 * @throws 	Exception
	 */
	private function _writeCellStyleXf(xmlWriter $objWriter = null, PHPExcel_Style $pStyle = null)
	{
		// xf
	 ...
	 * @throws 	Exception
	 */
	private function _writeCellStyleDxf(xmlWriter $objWriter = null, PHPExcel_Style $pStyle = null)
	{
		// dxf
	 ...
	 * @throws 	Exception
	 */
	private function _writeCellStyle(xmlWriter $objWriter = null, $pId = 0)
	{
		// cellStyle
	 ...
	 * @throws 	Exception
	 */
	private function _writeBorderPr(xmlWriter $objWriter = null, $pName = 'left', PHPExcel_Style_Border $pBorder = null)
	{
		// Write BorderPr
	 ...
	 * @throws 	Exception
	 */
	private function _writeNumFmt(xmlWriter $objWriter = null, PHPExcel_Style_NumberFormat $pNumberFormat = null, $pId = 0)
	{
		// numFmt
