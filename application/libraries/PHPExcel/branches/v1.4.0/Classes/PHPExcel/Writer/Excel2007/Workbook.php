...
class PHPExcel_Writer_Excel2007_Workbook extends PHPExcel_Writer_Excel2007_WriterPart
{
	 ...
	 * @throws 	Exception
	 */
	private function _writeFileVersion(xmlWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeWorkbookPr(xmlWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeBookViews(xmlWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// bookViews
	 ...
	 * @throws 	Exception
	 */
	private function _writeWorkbookProtection(xmlWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeCalcPr(xmlWriter $objWriter = null)
	{
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheets(xmlWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write sheets
	 ...
	 * @throws 	Exception
	 */
	private function _writeSheet(xmlWriter $objWriter = null, $pSheetname = '', $pSheetId = 1, $pRelId = 1)
	{
		if ($pSheetname != '') {
			// Write sheet
	 ...
	 * @throws 	Exception
	 */
	private function _writeDefinedNames(xmlWriter $objWriter = null, PHPExcel $pPHPExcel = null)
	{
		// Write defined names
